# How to Contribute to Monad

Contributions to this monad library are always welcome!
...
Releases for this monad library are made by a maintainer using a release branch
and a pull request.
